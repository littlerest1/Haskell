...
/* package Tortoise-1.0 */
#ifndef VERSION_Tortoise
#define VERSION_Tortoise "1.0"
#endif /* VERSION_Tortoise */
#ifndef MIN_VERSION_Tortoise
#define MIN_VERSION_Tortoise(major1,major2,minor) (\
  (major1) <  1 || \
  (major1) == 1 && (major2) <  0 || \
  (major1) == 1 && (major2) == 0 && (minor) <= 0)
#endif /* MIN_VERSION_Tortoise */
...
#define TOOL_VERSION_c2hs "0.16.3"
...
#define CURRENT_COMPONENT_ID "Tortoise-1.0-KMIeaWqmZxs46iI6DzBv5y-TortoiseTests"
